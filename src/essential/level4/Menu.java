...
public class Menu {
    ...
    public Menu() {
        ...
        menuMap.put(2.1, new MenuItem("Coke", 3.0, "펩시와 코카콜라 선택 제공"));
        menuMap.put(2.2, new MenuItem("Cidar", 3.0, "칠성사이다 밖에 없습니다"));
        menuMap.put(2.3, new MenuItem("Orange Soda", 4.0, "환타 오렌지맛"));
        menuMap.put(2.4, new MenuItem("Ice Americano", 3.5, "기름질 때는 쌉쌀한 아이스 아메리카노"));

        /*카테고리3 디저트*/
        categoryMap.put(3.0, "Desserts");
        menuMap.put(3.1, new MenuItem("Ice Cream", 1.5, "소프트 아이스크림, 쵸코는 매장 사정상 판매하지 않습니다"));
        menuMap.put(3.4, new MenuItem("Fried potato ", 2.0, "감자튀김, 햄버거 먹는데 당연히 같이 시키시죠"));
        menuMap.put(3.2, new MenuItem("Oreo Cake", 10.0, "오레오 케이크, 맥플러리 아닙니다."));
        menuMap.put(3.3, new MenuItem("Apple Pie", 10.0, "애플파이, 달콤상콤"));

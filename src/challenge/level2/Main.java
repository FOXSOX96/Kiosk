...
import challenge.level2.kiosk.KioskStep1Category;
...
public class Main {
    ...
    public static void main(String[] args) {
        /*속성*/
        Menu menu = new Menu();
        KioskStep1Category kioskStep1Category = new KioskStep1Category();
        Cart cart = new Cart();
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            while (selectNo != 0) {
                ...
                if (selectNo == 0) {
                    ...
                    // - Step1.카테고리 선택지점
                    kioskStep1Category.selectCategory(menu.getCategoryAll(), sc, menu, cart);
